...
export function ProductCard({ producto }) {
    ...
    const botonAñadirCarro = () => {
        if (producto.stock === 0) return; // No hacer nada si no hay stock
    ...
    return (
        <div className="Producto" data-categoria={producto.categoria.nombre}>
            ...
            <button
                ...
                disabled={producto.stock === 0} // Deshabilitar si el stock es 0
            >
                {producto.stock === 0 ? 'Sin stock' : 'Añadir al carro'}
